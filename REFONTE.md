...
> Dernière mise à jour : **2026-04-20** — sub-palier 5.2 complet (web scaffolding). HTML + sidebar + design tokens + polices Geist embeddées. Dashboard 100% self-contained (zéro CDN). Prêt pour 5.3 (page Overview branchée aux vraies données).
